...
project = u'The Face Recognition Grand Challenge (FRGC) ver2.0 Database (Bob API)'
import time
...
from bob.db.frgc.driver import Interface
...
man_pages = [
    ('index', 'bob', u'The Face Recognition Grand Challenge (FRGC) ver2.0 Database (Bob API) Documentation', [u'Idiap Research Institute'], 1)
]
...
def member_function_test(app, what, name, obj, skip, options):
  ...
  if len(name) > 1 and name[0] == '_':
    ...
    if name not in accepted_private_functions:
      # omit private functions that are not in the list of accepted private functions
      return True
    else:
